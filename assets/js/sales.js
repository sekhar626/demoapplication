...
function getStoredItems(){
    ...
    if(parsedDataFromLocal===null){
        ...
        console.log(parsedDataFromLocal,typeof(parsedDataFromLocal))
...
function addContainer(part) {
    ...
    cartButton.addEventListener('click',(part)=>{
...
let url = 'http://localhost:8081/allcategories?category_type=onSale'
